...
<div class="step">
    ...
    <pre class="local">
        ...
        rm webfaction/apache2.conf</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="local">
        <code>mv <em class="project-name"></em>/is_local.py <em class="project-name"></em>/settings/local.py</code>
    </pre>
</div>
### Database
<div class="step">
...
<div class="step">
    ...
    <pre class="local" file="settings/production.py">
        ...
        EMAIL_HOST_PASSWORD = ''
        EMAIL_HOST_USER = '' # eg. system@<em class="project-name"></em>.com</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="local">
        ...
        git commit -am 'Initial commit'</code>
    </pre>
    <p>Add the remote git repo we created earlier on Webfaction. We'll call it <strong>production</strong>.</p>
    <pre class="local">
        <code>git remote add <strong>production</strong> ssh://<em class="webfaction-username"></em>@<em class="webfaction-username"></em>.webfactional.com/~/webapps/git/repos/<em class="project-name"></em>.git</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        ...
        pip install --install-option="--user" virtualenvwrapper</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        ...
        workon env_<em class="project-name"></em></code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        <code>mkdir ~/webapps/<em class="project-name"></em>/app</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        <code>cd ~/webapps/<em class="project-name"></em>/app/</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        <code>rm -r ~/webapps/<em class="project-name"></em>/myproject</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        ...
        chmod +x $GIT_REPO/hooks/post-receive</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        <code>rm -r $HOME/webapps/git/repos/proj.git</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="local">
        <code>git push <strong>production</strong> master</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        <code>mv ~/webapps/<em class="project-name"></em>/app/webfaction/httpd.conf ~/webapps/<em class="project-name"></em>/apache2/conf</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        <code>python manage.py compress</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        <code>python manage.py collectstatic --noinput</code>
    </pre>
</div>
...
<div class="step">
    ...
    <pre class="remote">
        <code>~/webapps/<em class="project-name"></em>/apache2/bin/restart</code>
    </pre>
    <p>If it says that the web server is not running then start it.</p>
    <pre class="remote">
        <code>~/webapps/<em class="project-name"></em>/apache2/bin/start</code>
    </pre>
</div>
...
<div class="step">
    <pre class="remote">
        ...
        cd ~/webapps/<em class="project-name"></em>/app</code>
    </pre>
</div>
...
<div class="step">
    <p>Collecct local static files</p>
    <pre class="remote">
        <code>python manage.py collectstatic --noinput</code>
    </pre>
</div>
...
<div class="step">
    ...
    ~/webapps/<em class="project-name"></em>/apache2/bin/stop</code>
    </pre>
</div>
...
<div class="step">
    <pre class="local">
        <code>pip install -U -r requirements/development.txt</code>
    </pre>
    <pre class="remote">
